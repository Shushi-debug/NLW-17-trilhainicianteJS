...
const metasRealizadas = async () => {
    ...
    await select({
        message: "Metas Realizadas | Total de metas realizadas:" + realizadas.length,
        choices: [...realizadas]
    })
}
...
const metasAbertas = async () => {
    ...
    await select({
        message: "Metas Abertas | Total de metas abertas: " + abertas.length,
        choices: [...abertas]
    })
}
